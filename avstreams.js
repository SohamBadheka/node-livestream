...
(function() {
  ...
  AVStream = (function() {
    ...
    AVStream.prototype.updateSPS = function(nalUnit) {
      var e, error, frameSize, isConfigUpdated, sps;
  ...
  MP4Stream = (function(superClass) {
    ...
    MP4Stream.create = function(filename) {
      var ascBuf, ascInfo, bits, err, error, mp4File, mp4Stream, streamId;
      try {
  ...
  api = {
    ...
    get: function(streamId) {
      var app, dir, e, error, error1, filename, filetype, match, pathSep, stream;
