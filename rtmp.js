    ...
    RTMPSession.prototype.handleData = function(buf, callback) {
      ...
      if (this.state !== SESSION_STATE_HANDSHAKE_DONE) {
        ...
        consumeNextRTMPMessage = (function(_this) {
          return function() {
            var acknowledgementMessage, audioData, bufferLength, commandMessage, dataMessage, debugMsg, dts, e, error, error1, j, len1, msec, newChunkSize, packageJson, parseResult, pts, ref, results, rtmpMessage, stream, streamID, timestamp, userControlMessage, videoData;
            if (buf == null) {
              onConsumeAllPackets();
              return;
            }
